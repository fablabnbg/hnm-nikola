...
<img src="/assets/img/spomsored_by_siemens2.png" class = "footer_img" alt="Sponsor: Siemens" />
<img src="/assets/img/partner2.png" class = "footer_img" alt="Partner: Iena,Consumenta"/>'
