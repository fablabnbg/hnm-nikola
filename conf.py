...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date} <a href="mailto:{email}">{author}</a>     {license}         <a href="/impressum/">Impressum</a> <img src="/assets/img/partner2.png" class = "footer_img" alt="Partner: Iena,Consumenta"/>'
