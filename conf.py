...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date} <a href="mailto:{email}">{author}</a>     {license}        - <a href="/impressum/">Impressum</a> {partner}<img src="./files/asserts/img/partner.png" class = "mail" alt="img-mail" />'
